...
We implement the minimization of the energy $E_{sf}$ by using the optimization algorithm described in \cite{Garg:2013hu} \footnote{We used the publicly available code at \url{http://bitbucket.org/troussos/mfsf/}}. 
