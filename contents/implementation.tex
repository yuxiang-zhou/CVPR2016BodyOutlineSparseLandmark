...
\begin{center}
 \begin{tabular}{ccc}
\subfigure[]{
    \newcommand{\flowh}{0.12\columnwidth}
    \includegraphics[height=\flowh]{resources/Fig_Flows/1}
    \includegraphics[height=\flowh]{resources/Fig_Flows/2}
    \includegraphics[height=\flowh]{resources/Fig_Flows/3}
    \includegraphics[height=\flowh]{resources/Fig_Flows/4}
...
\subfigure[]{
    \includegraphics[width=0.2\textwidth]{resources/models}
}
 \end{tabular}
\end{center}
\caption{(a) . (b) }
...
%We minimize this energy jointly with respect to $\bm{u}_n(\bx)$ and $\bm{v}_i(\bx)$. 
