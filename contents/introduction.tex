...
\begin{figure}[t!]
    ...
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_1_0}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_1_1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_1_2}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_2_0}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_2_1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.075\textwidth}
            \includegraphics[height=2.35cm]{resources/Fig_Intro/intro_2_2}
    \end{subfigure}
