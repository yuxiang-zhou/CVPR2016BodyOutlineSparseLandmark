...
\begin{figure}[!t]
\centering
\includegraphics[width=0.5\textwidth]{Supplementory_Meterial/Fittings/fittings}
...
\begin{figure}[!b]
    ...
    \begin{subfigure}[b]{0.43\textwidth}
            \includegraphics[width=\textwidth]{Supplementory_Meterial/Model_Analysis/sr_ear}
        %\caption{dAAMs dense shape reconstruction}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.43\textwidth}
            \includegraphics[width=\textwidth]{Supplementory_Meterial/Model_Analysis/sr_face}
...
\begin{figure}[!t]
    \centering
    \begin{subfigure}[b]{0.43\textwidth}
            \includegraphics[width=\textwidth]{Supplementory_Meterial/Model_Analysis/var_ratio}
        %\caption{dAAMs vs AAMs Variance Ratio}
    \end{subfigure}
    \begin{subfigure}[b]{0.43\textwidth}
            \includegraphics[width=\textwidth]{Supplementory_Meterial/Model_Analysis/cumu_var_ratio}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{Supplementory_Meterial/Models/models}
...
\begin{figure}[!b]
    \centering
    %\vspace*{-0.2in}
    \includegraphics[width=0.5\textwidth]{Supplementory_Meterial/Fig_Draw/draw}
...
\begin{figure}[!t]
    ...
    \begin{subfigure}[b]{0.15\textwidth}
            \includegraphics[height=\textwidth]{Supplementory_Meterial/Segmentation_Measure/ear}
        %\caption{Ear Initial Bounding Box}
    \end{subfigure}
    \begin{subfigure}[b]{0.15\textwidth}
            \includegraphics[height=\textwidth]{Supplementory_Meterial/Segmentation_Measure/bottle}
        %\caption{Bottle Initial Bounding Box}
    \end{subfigure}
    \begin{subfigure}[b]{0.15\textwidth}
            \includegraphics[height=\textwidth]{Supplementory_Meterial/Segmentation_Measure/body}
